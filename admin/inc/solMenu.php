...
<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
	<div class="navbar-header">
		<ul class="nav navbar-nav flex-row">
			<li class="nav-item mr-auto"><a class="navbar-brand" target="_blank" href="<?php echo URL; ?>"><img style="width: 43px; " src="<?php echo URL; ?>images/<?php echo $ayar["logo"]; ?>" alt="<?php echo $ayar["site_title"]; ?>"></a></li>
		...
		<li class=" nav-item"><a href="javascript:void(0);"><i class="feather icon-layout"></i><span class="menu-title" data-i18n="Menu Levels">Kategoriler</span></a>
			...
			<li class=" nav-item"><a href="javascript:void(0);"><i class="feather icon-user"></i><span class="menu-title" data-i18n="Menu Levels">Kullanıcılar</span></a>
				<ul class="menu-content">
					...
					<li  class='<?php classActive('kullanicisifre',@$_GET['sayfa']);?>'><a href="index.php?sayfa=kullanicisifre"><i class="feather icon-align-justify"></i><span class="menu-item" data-i18n="Second Level">Şifre İşlemleri</span></a>
					</li>
