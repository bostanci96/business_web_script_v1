	...
	<div class="content-header row">
		<div class="content-header-left col-md-9 col-12 mb-2">
			<div class="row breadcrumbs-top">
				<div class="col-12">
					<h2 class="content-header-title float-left mb-0">Portfolyo Ekle</h2>
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="<?php echo ADMIN_URL ;?>">Anasayfa</a>
							</li>
							<li class="breadcrumb-item"><a href="index.php?sayfa=sayfalar3">Tümü</a>
							</li>
							<li class="breadcrumb-item active"><a href="javascript:void(0);">Yeni Portfolyo Ekle</a>
							</li>
						</ol>
					</div>
				</div>
				...
				<div class="col-12">
					<div class="card">
						<div class="card-header">
							<h4 class="card-title">   <p><b>Yeni</b> Portfolyo Ekle</p> </h4>
						</div>
						<div class="card-content">
							<div class="card-body">
								<form role="form" class="form-horizontal"  id="forms" method="POST" id="forms" method="POST" action="ajax.php?p=sayfa_ekle"  enctype="multipart/form-data">
									<input type="hidden" name="secenekHaber" value="2">
									<div class="form-body">
										<div class="row">
											<div class="col-12">
												<div class="form-group row">
													...
													<div class="col-md-10">
														<fieldset class="position-relative has-icon-left">
															<input type="text" class="form-control" id="iconLeft1" placeholder="Portfolyo Başlığı girin " name="sayfa_adi">
											...
											<div class="col-12">
												<div class="form-group row">
													...
													<div class="col-md-10">
														<fieldset class="position-relative has-icon-left">
															<input type="text" class="form-control" id="iconLeft1" placeholder="Portfolyo Kısa Açıklaması " name="sayfa_desc">
															<div class="form-control-position">
											...
											<div class="col-12">
												<div class="form-group row">
													<div class="col-md-2">
														<span>Portfolyo Kategori Seç</span>
													</div>
													<div class="col-md-10">
