	...
	<div class="content-header row">
		<div class="content-header-left col-md-9 col-12 mb-2">
			<div class="row breadcrumbs-top">
				<div class="col-12">
					<h2 class="content-header-title float-left mb-0">Porfolyo İşlemleri</h2>
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="<?php echo ADMIN_URL ;?>">Anasayfa</a>
							</li>
							<li class="breadcrumb-item active"><a href="javascript:void(0);">Tüm Porfolyolar </a>
							</li>
						</ol>
					</div>
				</div>
				...
				<div class="actions action-btns"><div class="dt-buttons btn-group">
					...
					<table class="table data-list-view">
						...
						<tbody>
							...
							<?php
							$uyeQuery = $db->query("SELECT * FROM sayfalar WHERE secenekHaber=2");
							if($uyeQuery->rowCount()){
								foreach($uyeQuery as $uyeRow){
									...
									<tr>
										...
										<td><a target="_blank" href="<?php echo URL. $uyeRow["sayfa_url"];?>"> Git </a></td>
											...
											<td > <div class="dropdown dropright">
												...
												<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
													...
													<a class="dropdown-item" href="javascript:;" onclick="durumDegis(<?php echo $uyeRow["sayfa_id"];?>);">
														<?php if($uyeRow["sayfa_durum"]==1){echo ' Gizle';}else{echo ' Yayına Al';}?>
													</a>
													<a class="dropdown-item"  onclick="TekSil(<?php echo $uyeRow["sayfa_id"];?>);" > Sil</a>
												</div>
											</div>   
			...
			function durumDegis(sayfaid){
				$.post('ajax.php?p=sayfaonay', {id: sayfaid}, function (data) {
					if(data=="yasaklama-basarili"){
						sweetAlert({
							title	: "Başarılı",
							text 	: "Başarılı bir şekilde gizlendi.",
							type	: "success"
						},
						function(){
							window.location.reload(true);
