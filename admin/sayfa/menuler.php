								...
								<tr>
									...
									<td>
												...
												<div class="chip ">
													<div class="chip-body">
														<div class="chip-text">
<?php echo $kRow["menu_type"]==0 ? 'Header(Üst) Menü' : null; ?>
																  <?php echo $kRow["menu_type"]==1 ? 'Footer(1) Menü' : null; ?>   
																<?php echo $kRow["menu_type"]==11 ? 'Footer(2) Menü' : null; ?> 
																<?php echo $kRow["menu_type"]==22 ? 'Footer(3) Menü' : null; ?> 
																<?php echo $kRow["menu_type"]==33 ? 'Footer(4) Menü' : null; ?> 
																<?php echo $kRow["menu_type"]==44 ? 'Footer(5) Menü' : null; ?>    
</div>
													</div>
												</div>
									</td>
