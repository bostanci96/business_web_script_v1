													...
													<div class="col-md-10">
														<fieldset class="form-group">
															<select class="form-control" id="basicSelect" name="menu_type">
																...
																<option value="1">Footer(1) Menü</option>
																<option value="11">Footer(2) Menü</option>
																<option value="22">Footer(3) Menü</option>
																<option value="33">Footer(4) Menü</option>
																<option value="44">Footer(5) Menü</option>                                                    
															</select>
														</fieldset>
													</div>
												</div>
