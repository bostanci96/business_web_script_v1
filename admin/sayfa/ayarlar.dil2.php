										...
										<div class="tab-content pt-1">
											<div class="tab-pane <?php if($_SESSION["uye_rutbe"]==0 OR $_SESSION["uye_rutbe"]==1){ echo "active";} ?> " id="home-fill" role="tabpanel" aria-labelledby="home-tab-fill">
												...
												<form role="form" class="form-horizontal"  id="forms2" method="POST" action="ajax.php?p=dil2_anasayfa_ayarlari"  enctype="multipart/form-data">
														<div class="card-header">
							<h4 class="card-title">   <p><b>Üretim</b> devam Düzenle </p> </h4>
						</div>
													<div class="col-12">
													...
													<div class="card-header">
							<h4 class="card-title">   <p><b>Hakkımızda</b> yeni Düzenle </p> </h4>
						</div>
						<div class="col-12">
														<div class="form-group row">
															<div class="col-md-2">
													...
													<div class="col-12">
														...
														<div class="card-header">
							<h4 class="card-title">   <p><b>Sürdürülebilirlik</b>  Düzenle </p> </h4>
						</div>
													<div class="col-12">
														<div class="form-group row">
															<div class="col-md-2">
													...
													<div class="col-12">
														...
														<div class="card-header">
							<h4 class="card-title">   <p><b>Referanslar</b>  Düzenle </p> </h4>
						</div>
													<div class="col-12">
														<div class="form-group row">
															<div class="col-md-2">
													...
													<div class="card-header">
							<h4 class="card-title">   <p><b>Tasarım</b>  Düzenle </p> </h4>
						</div>
													<div class="col-12">
														<div class="form-group row">
															<div class="col-md-2">
