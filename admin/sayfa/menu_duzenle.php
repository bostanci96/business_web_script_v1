...
<div class="col-12">
													...
													<div class="col-md-10">
														<fieldset class="form-group">
															<select class="form-control" id="basicSelect" name="menu_type">
																...
																<option value="1"  <?php echo $menuRow["menu_type"]==1 ? 'selected' : null; ?>>Footer(1) Menü</option>     
																<option <?php echo $menuRow["menu_type"]==11 ? 'selected' : null; ?> value="11">Footer(2) Menü</option>
																<option <?php echo $menuRow["menu_type"]==22 ? 'selected' : null; ?> value="22">Footer(3) Menü</option>
																<option <?php echo $menuRow["menu_type"]==33 ? 'selected' : null; ?> value="33">Footer(4) Menü</option>
																<option <?php echo $menuRow["menu_type"]==44 ? 'selected' : null; ?> value="44">Footer(5) Menü</option>                                                  
															</select>
														</fieldset>
													</div>
												</div>
								...
								<div class="col-md-5"><img src="<?php echo URL."images/menuPhotos/".$menuRow["menu_resim"];?>" style="width: 150px;"></div>
