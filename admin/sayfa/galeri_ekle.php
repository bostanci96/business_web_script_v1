                                                    ...
                                                    <div class="col-md-10">
                                                        <fieldset class="form-group">
                                                            <select name="fotograf_bolum2" class="form-control">
                                                                <option value="23">Hakkımızda Galeri Olsun</option>
                                                                <option value="32">Ürünler Galeri Olsun</option>
                                                                <option value="888">Referans Galeri Olsun</option>
                                                                <option value="24698">İnstagram Galeri Olsun</option>
