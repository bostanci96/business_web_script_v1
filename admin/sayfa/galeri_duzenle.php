...
<div class="content-wrapper">
	...
	<div class="content-body">
     ...
     <div class="col-12">
                                                <div class="form-group row">
                                                    <div class="col-md-2">
                                                        <span>Galeri Seçenekleri</span>
                                                    </div>
                                                    <div class="col-md-10">
                                                        <fieldset class="form-group">
                                                            <select name="fotograf_bolum2" class="form-control">
                                                                <option value="23" <?php echo $slideRow["fotograf_bolum2"]==23 ? 'selected' : null; ?>>Hakkımızda Galeri Olsun</option>
                                                                <option value="32" <?php echo $slideRow["fotograf_bolum2"]==32 ? 'selected' : null; ?>>Ürünler Galeri Olsun</option>
                                                                <option value="888" <?php echo $slideRow["fotograf_bolum2"]==888 ? 'selected' : null; ?>>Referans Galeri Olsun</option>
                                                              <option value="24698" <?php echo $slideRow["fotograf_bolum2"]==24698 ? 'selected' : null; ?>>İnstagram Galeri Olsun</option>
                                                            </select>
                                                        </fieldset>
                                                    </div>
                                                </div>
