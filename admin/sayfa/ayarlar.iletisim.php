										...
										<div class="row">
												...
												<div class="form-group row">
													...
													<div class="col-md-10">
														<fieldset class="form-group">
															<textarea class="form-control" id="basicTextarea" rows="3" placeholder="Canlı Destek Kodunuz" name="cdestek" ><?php echo $ayarRow["cdestek"];?></textarea>
														</fieldset>
													</div>
												</div>
											</div>
											<div class="col-12">
												<div class="form-group row">
													...
													<div class="col-md-10">
														<fieldset class="form-group">
															<textarea class="form-control" id="basicTextarea" rows="3" placeholder="Google Analytics Kodunuz" name="ganaltyc" ><?php echo $ayarRow["ganaltyc"];?></textarea>
														</fieldset>
													</div>
												</div>
											</div>
											<div class="col-12">
												<div class="form-group row">
													...
													<div class="col-md-10">
														<fieldset class="form-group">
															<textarea class="form-control" id="basicTextarea" rows="3" placeholder="Google Search Console Kodunuz" name="gconsol" ><?php echo $ayarRow["gconsol"];?></textarea>
														</fieldset>
													</div>
												</div>
												...
												<div class="form-group row">
													...
													<div class="col-md-10">
														<fieldset class="form-group">
															<textarea class="form-control" id="basicTextarea" rows="3" placeholder="Google Search Console Kodunuz" name="footercop" ><?php echo $ayarRow["footercop"];?></textarea>
														</fieldset>
													</div>
												</div>
											</div>	
